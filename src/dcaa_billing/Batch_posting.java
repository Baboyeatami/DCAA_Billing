    ...
    public Batch_posting() {
        ...
        RemovedStudent.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                StudentId = StudentTable.getValueAt(StudentTable.getSelectedColumn(), 0).toString();
                System.out.println(StudentTable.getValueAt(StudentTable.getSelectedColumn(), 0));
        ...
        RemovedCharge.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ChargeId = ChargeTable.getValueAt(ChargeTable.getSelectedColumn(), 0).toString();
                System.out.println(ChargeTable.getValueAt(ChargeTable.getSelectedColumn(), 0).toString());
    ...
    void loadDisplayStudentlist() {
        try {
            ...
            for (int i = 0; i < Studentlist.size(); i++) {
                ...
                if (rs.next()) {
                    StudentModel.addRow(new Object[]{rs.getString(1), rs.getString(2) + " " + rs.getString(3) + " " + rs.getString(4)});
                }
