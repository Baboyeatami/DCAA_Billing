...
public class Balances extends javax.swing.JFrame {
    ...
    void load_Balance(String id) {
        ...
        try {
            ...
            ps = c.prepareStatement("Select F_name,M_name,L_name,GradeLevel,Status from student_info where id='" + id + "'");
            rs = ps.executeQuery();

            if (rs.next()) {
                StudentId.setText("Student ID: " + id);
                Student_Name.setText("Name: " + rs.getString("L_name") + ", " + rs.getString("F_name") + " " + rs.getString("M_name") + "  Grade Level: " + rs.getString("GradeLevel") + "  Status: " + rs.getString("Status"));
            }
            ps.close();
            rs.close();
