...
public class Student_list_adder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 40, -1, 20));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 73, 418, 420));
        ...
        status.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "NEW", "OLD", "TRANSFEREE", "RETURNEE" }));
        status.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                statusActionPerformed(evt);
            }
        });
        getContentPane().add(status, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 40, 130, -1));

        jLabel4.setText("Search");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 16, -1, -1));
    ...
    void SearchName() {
        try {
            ...
            if (SearchCretiar.getSelectedIndex() == 0) {
                ps = c.prepareStatement("Select id,F_name,M_name,L_name from student_info where L_name like '" + S + "' and Status='" + Status + "' limit 10");
                rs = ps.executeQuery();

            } else if (SearchCretiar.getSelectedIndex() == 1) {
                ps = c.prepareStatement("Select id,F_name,M_name,L_name from student_info where id like '" + S + "' and Status='" + Status + "' limit 10");
                rs = ps.executeQuery();

            } else if (SearchCretiar.getSelectedIndex() == 2) {
                ps = c.prepareStatement("Select id,F_name,M_name,L_name from student_info where F_name like '" + S + "' and Status='" + Status + "' limit 10");
                rs = ps.executeQuery();
