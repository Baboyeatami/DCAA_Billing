...
public class Section extends javax.swing.JInternalFrame {
    ...
    void remove_Section(String Section) {
        try {
            DBConnection.init();
            Connection c = DBConnection.getConnection();
            PreparedStatement ps;
            ps = c.prepareStatement("DELETE FROM section WHERE idsection = '" + Section + "'");

            int option = JOptionPane.showConfirmDialog(this, "This Section is about to be Deleted, Do you want to Continue?");
            if (option == 0) {
                ps.execute();
