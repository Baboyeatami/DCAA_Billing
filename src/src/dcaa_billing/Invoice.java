...
public class Invoice extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        GradeandSection1 = new javax.swing.JLabel();
        ...
        jPanel1.add(Name, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 40, 430, 20));

        Status.setBackground(new java.awt.Color(255, 255, 255));
        Status.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        Status.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(Status, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 60, 260, 20));
        ...
        GradeandSection1.setBackground(new java.awt.Color(255, 255, 255));
        GradeandSection1.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        GradeandSection1.setForeground(new java.awt.Color(255, 255, 255));
        GradeandSection1.setText("Grade and Section:");
        jPanel1.add(GradeandSection1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 60, 220, 20));
    ...
    void PrintReceibo(String Id, String Sy) {
        try {
            JasperReport JR;
            JasperPrint JP;
            String ORFormatted = "NS" + String.format("%08d", OrNumber);
            ...
            String SQL = "Select * from Invoice where Student_Info_idStudent_Info='" + Id + "' AND OrNum='" + ORFormatted + "'";
            ...
            m.put("Department", Status.getText());
    ...
    void REPrintReceibo(String Id, String ORNUM) throws SQLException {
        try {
            ...
            String SQL = "Select * from Invoice where Student_Info_idStudent_Info='" + Id + "' AND OrNum='" + ORNUM + "'";
            String Location = System.getProperty("user.dir") + "\\\\reports\\\\";
            ...
            // String ORFormatted = "NS" + String.format("%08d", ORNUM);
            PreparedStatement ps = c.prepareStatement("SELECT sum(Value)  FROM dcaa_databse.invoice where Student_Info_idStudent_Info= '" + Id + "' and OrNum='" + ORNUM + "'");
    ...
    void LoadStudentInfo() {
        ...
        try {
            ...
            PreparedStatement ps;
            ResultSet rs;
            ps = c.prepareStatement("Select F_name,M_name,L_name,GradeLevel,Status from student_info where id='" + Student_Id.getText() + "'");
            rs = ps.executeQuery();
            if (rs.next()) {
                Name.setText(rs.getString(3) + "," + rs.getString(1) + " " + rs.getString(2));
                Status.setText("Status:" + rs.getString("Status"));
                GradeandSection1.setText(rs.getString("GradeLevel"));
    ...
    void PartialPayment() {
        try {
            ...
            if (Amount > Cash) {
                ...
                String OrFormated = "NS" + String.format("%08d", OrNumber);
                if (rs.next()) {
                    ps = c.prepareStatement("Insert into invoice (Value, Particulars, Category_of_charges_idCategory_of_charges, Student_Info_idStudent_Info, OrNum, DATE, School_Year_idSchool_Year, UseAccounts_idUseAccounts)values" + "('" + rs.getString(1) + "','" + RefNo + "','" + rs.getString(2) + "','" + Student_Id.getText() + "','" + OrFormated + "','" + timeStamp + "','" + String.valueOf(idSydisplay.get(SchoolYear.getSelectedIndex())) + "','2')");
                    ps.execute();
            ...
            } else {
                {
                    ...
                    if (partialPayMode) {
                        if (Cash >= partial_Amount) {
                            ...
                            rs = ps.executeQuery();
                            if (rs.next()) {
                                ps = c.prepareStatement("Insert into invoice (Value, Particulars, Category_of_charges_idCategory_of_charges, Student_Info_idStudent_Info, OrNum, DATE, School_Year_idSchool_Year, UseAccounts_idUseAccounts)values" + "('" + partial_Amount + "','" + RefNo + "','" + rs.getString(2) + "','" + Student_Id.getText() + "','" + OrFormated + "','" + timeStamp + "','" + String.valueOf(idSydisplay.get(SchoolYear.getSelectedIndex())) + "','" + User + "')");
                                ps.execute();
    ...
    void LoadORNum() {
        try {
            ...
            rs = ps.executeQuery();
            while (rs.next()) {
                String ORFormatted = rs.getString("orNum");

                OrNumber = Integer.parseInt(ORFormatted.substring(2)) + 1;
            }
            ORnum.setText("Official Receipt No. NS" + String.format("%08d", OrNumber));
    ...
    private javax.swing.JLabel GradeandSection1;
