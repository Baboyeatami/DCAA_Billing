...
public class DBConnection {
    ...
    public static void init() {
        try {
            ...
            Myconnection = DriverManager.getConnection("jdbc:mysql://" + IpAddress + ":3306/dcaa_databse?serverTimezone=UTC&allowPublicKeyRetrieval=true&useSSL=false", "root", "root");
